 ...
 * @param {Object} parserOptionsForFixer the object that will be used by the fixer for dry running of the fix
 * @returns {Problem[]} An array of reported problems
 */
function runRules(sourceCode, configuredRules, ruleMapper, parserOptions, parserName, settings, filename, disableFixes, cwd, parserOptionsForFixer = {}) {
