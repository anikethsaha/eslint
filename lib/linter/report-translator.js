 ...
 * @param {Object} parserOptionsForFixer data about the parser and its options.
 * @returns {({text: string, range: number[]}|null)} The fix for the descriptor
 */
function normalizeFixes(descriptor, sourceCode, parserOptionsForFixer = {}) {
    if (typeof descriptor.fix !== "function") {
        return null;
    }

    const ruleFixer = Object.freeze(new RuleFixer({ sourceCode, parserOptionsForFixer }));
 ...
 * @param {{ruleId: string, severity: number, sourceCode: SourceCode, messageIds: Object, disableFixes: boolean, parserOptionsForFixer: Object}} metadata Metadata for the reported problem
...
module.exports = function createReportTranslator(metadata) {
    ...
    return (...args) => {
        ...
        return createProblem({
            ...
            fix: metadata.disableFixes ? null : normalizeFixes(descriptor, metadata.sourceCode, metadata.parserOptionsForFixer),
